...
import { _ as __nuxt_component_0$1$1 } from '../_/QBtn.mjs';
  ...
  async setup(__props) {
    ...
    const handleCourseEnrolling = (course) => {
      if (!isAuthenticated.value)
        return navigateTo(`/auth/signin?redirect_to=${(void 0).location.origin}/courses/${course.id}`);
              ...
              _push2(ssrRenderComponent(_component_q_card_section, { class: "p-8" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`</div>`);
                    _push3(ssrRenderComponent(_component_q_btn, {
                      onClick: ($event) => handleCourseEnrolling(course),
                      unelevated: "",
                      rounded: "",
...
//# sourceMappingURL=FeaturesCoursesSection-B3vrP-ks.mjs.map
