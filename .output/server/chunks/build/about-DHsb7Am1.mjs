...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><h3 class="text-center font-semibold text-primary">Welcome to the about page</h3><p class="text-xl text-center m-0">This page contains information about our organization and its mission.</p><div class="mt-6 px-5 grid grid-cols-1 gap-6 md:grid-cols-4"><!--[-->`);
...
//# sourceMappingURL=about-DHsb7Am1.mjs.map
