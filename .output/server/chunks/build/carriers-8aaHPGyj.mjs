...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const { data } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/v1/jobs", "$zdxQRn6Pok")), __temp = await __temp, __restore(), __temp);
    useSeoMeta({
      title: "Carriers",
...
//# sourceMappingURL=carriers-8aaHPGyj.mjs.map
