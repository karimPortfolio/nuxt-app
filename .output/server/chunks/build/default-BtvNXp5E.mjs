import { getCurrentInstance, computed, h, inject, ref, watch, onBeforeUnmount, onMounted, reactive, provide, withCtx, createVNode, renderSlot, mergeProps, createTextVNode, withDirectives, createBlock, openBlock, unref, toDisplayString, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderSlot, ssrRenderAttr, ssrGetDirectiveProps, ssrInterpolate, ssrRenderAttrs } from 'vue/server-renderer';
import { p as publicAssetsURL } from '../routes/renderer.mjs';
import { u as useAuthStore } from './auth-OUqj8N6e.mjs';
import { k as client, c as createComponent, x as noop, B as layoutKey, C as emptyRenderFn, D as position, s as stopAndPrevent, l as stop, t as listenOpts, j as isRuntimeSsrPreHydration, E as pageContainerKey, _ as _export_sfc } from './server.mjs';
import { d as hUniqueSlot, h as hSlot, a as hMergeSlot } from '../_/render.mjs';
import { n as nonRoundBtnProps, c as getBtnDesignAttr, _ as __nuxt_component_0$1, u as useRouterLinkProps, d as useRouterLink, a as __q_directive_0 } from '../_/QBtn.mjs';
...
import { i as isKeyCode } from '../_/QSpinner.mjs';
            ...
            _push2(ssrRenderComponent(_component_q_toolbar, { class: "container mx-auto" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`</div><div${_scopeId2}><div class="relative"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_q_btn, {
                    flat: "",
                    round: "",
                    "no-caps": "",
                    class: "bg-white/15 backdrop-blur-sm hover:bg-white/25 transition-all duration-300"
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_q_avatar, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            var _a, _b, _c, _d;
                            if (_push5) {
                              _push5(`<img${ssrRenderAttr("src", ((_a = unref(user)) == null ? void 0 : _a.photoURL) || "https://ui-avatars.com/api/?name=" + (((_b = unref(user)) == null ? void 0 : _b.displayName) || "User"))}${_scopeId4}>`);
                            } else {
                              return [
                                createVNode("img", {
                                  src: ((_c = unref(user)) == null ? void 0 : _c.photoURL) || "https://ui-avatars.com/api/?name=" + (((_d = unref(user)) == null ? void 0 : _d.displayName) || "User")
                                }, null, 8, ["src"])
                              ];
                            }
                          }),
                        ...
                        _push4(ssrRenderComponent(_component_q_menu, {
                          class: "bg-white/95 backdrop-blur-xl rounded-xl shadow-2xl border border-gray-200/50 py-2 w-72",
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            var _a, _b, _c, _d;
                            if (_push5) {
                              _push5(`<div class="px-4 py-3 border-b border-gray-100"${_scopeId4}><div class="flex items-center space-x-3"${_scopeId4}>`);
                              _push5(ssrRenderComponent(_component_q_avatar, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  var _a2, _b2, _c2, _d2;
                                  if (_push6) {
                                    _push6(`<img${ssrRenderAttr("src", ((_a2 = unref(user)) == null ? void 0 : _a2.photoURL) || "https://ui-avatars.com/api/?name=" + (((_b2 = unref(user)) == null ? void 0 : _b2.displayName) || "User"))}${_scopeId5}>`);
                                  } else {
                                    return [
                                      createVNode("img", {
                                        src: ((_c2 = unref(user)) == null ? void 0 : _c2.photoURL) || "https://ui-avatars.com/api/?name=" + (((_d2 = unref(user)) == null ? void 0 : _d2.displayName) || "User")
                                      }, null, 8, ["src"])
                                    ];
                                  }
                                }),
                              ...
                              _push5(`<div class="flex flex-col"${_scopeId4}><span class="font-medium text-gray-800"${_scopeId4}>${ssrInterpolate(((_a = unref(user)) == null ? void 0 : _a.displayName) || "User")}</span><span class="text-sm text-blue-600 truncate max-w-[180px]"${_scopeId4}>${ssrInterpolate((_b = unref(user)) == null ? void 0 : _b.email)}</span></div></div><div class="mt-2 bg-blue-50 rounded-lg px-3 py-1.5 text-sm text-blue-700 flex items-center"${_scopeId4}>`);
                              ...
                              _push5(`<span${_scopeId4}>Verified Account</span></div></div>`);
                              _push5(ssrRenderComponent(_component_q_list, { padding: "" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(_component_q_item, mergeProps({
                                      clickable: "",
                                      to: "/profile",
                                      class: "hover:bg-blue-50/80 rounded-lg mx-1 my-0.5 transition-all duration-300 hover:translate-x-1 group"
                                    }, ssrGetDirectiveProps(_ctx, _directive_ripple)), {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                            ...
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(ssrRenderComponent(_component_q_icon, {
                                                  name: "person",
                                                  class: "text-blue-600 bg-blue-100 p-1 rounded-full group-hover:bg-blue-200 transition-colors"
                                          ...
                                          _push7(ssrRenderComponent(_component_q_item_section, { side: "" }, {
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(ssrRenderComponent(_component_q_icon, {
                                                  name: "chevron_right",
                                    ...
                                    _push6(ssrRenderComponent(_component_q_item, mergeProps({
                                      clickable: "",
                                      to: "/dashboard",
                                      class: "hover:bg-indigo-50/80 rounded-lg mx-1 my-0.5 transition-all duration-300 hover:translate-x-1 group"
                                    }, ssrGetDirectiveProps(_ctx, _directive_ripple)), {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(ssrRenderComponent(_component_q_item_section, { avatar: "" }, {
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(ssrRenderComponent(_component_q_icon, {
                                                  name: "dashboard",
                                                  class: "text-indigo-600 bg-indigo-100 p-1 rounded-full group-hover:bg-indigo-200 transition-colors"
                                                }, null, _parent8, _scopeId7));
                                              } else {
                                                return [
                                                  createVNode(_component_q_icon, {
                                            ...
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(ssrRenderComponent(_component_q_icon, {
                                                  name: "chevron_right",
                                                  size: "xs",
                                                  class: "text-gray-400 group-hover:text-indigo-500 transform group-hover:translate-x-1 transition-transform"
                                                }, null, _parent8, _scopeId7));
                                              } else {
                                                return [
                                                  createVNode(_component_q_icon, {
                                    ...
                                    _push6(ssrRenderComponent(_component_q_item, mergeProps({
                                      clickable: "",
                                      to: "/settings",
                                      class: "hover:bg-purple-50/80 rounded-lg mx-1 my-0.5 transition-all duration-300 hover:translate-x-1 group"
                                    }, ssrGetDirectiveProps(_ctx, _directive_ripple)), {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(ssrRenderComponent(_component_q_item_section, { avatar: "" }, {
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(ssrRenderComponent(_component_q_icon, {
                                                  name: "settings",
                                                  class: "text-purple-600 bg-purple-100 p-1 rounded-full group-hover:bg-purple-200 transition-colors"
                                                }, null, _parent8, _scopeId7));
                                              } else {
                                                return [
                                                  createVNode(_component_q_icon, {
                                    ...
                                    _push6(ssrRenderComponent(_component_q_item, mergeProps({
                                      clickable: "",
                                      onClick: unref(useAuthStore)().signOut,
                                      class: "hover:bg-red-50/80 rounded-lg mx-1 my-0.5 transition-all duration-300 hover:translate-x-1 group"
                                    }, ssrGetDirectiveProps(_ctx, _directive_ripple)), {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(ssrRenderComponent(_component_q_item_section, { avatar: "" }, {
                                            default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                              if (_push8) {
                                                _push8(ssrRenderComponent(_component_q_icon, {
                                                  name: "logout",
                                                  class: "text-red-600 bg-red-100 p-1 rounded-full group-hover:bg-red-200 transition-colors"
                                                }, null, _parent8, _scopeId7));
                                              } else {
                                                return [
                                                  createVNode(_component_q_icon, {
                              ...
                              return [
                                createVNode("div", { class: "px-4 py-3 border-b border-gray-100" }, [
                                  createVNode("div", { class: "flex items-center space-x-3" }, [
                                    createVNode(_component_q_avatar, {
                                      ...
                                      default: withCtx(() => {
                                        ...
                                        return [
                                          createVNode("img", {
                                            src: ((_a2 = unref(user)) == null ? void 0 : _a2.photoURL) || "https://ui-avatars.com/api/?name=" + (((_b2 = unref(user)) == null ? void 0 : _b2.displayName) || "User")
                                          }, null, 8, ["src"])
                                        ];
                                      }),
                                      _: 1
                                    ...
                                    createVNode("div", { class: "flex flex-col" }, [
                                      createVNode("span", { class: "font-medium text-gray-800" }, toDisplayString(((_c = unref(user)) == null ? void 0 : _c.displayName) || "User"), 1),
                                      createVNode("span", { class: "text-sm text-blue-600 truncate max-w-[180px]" }, toDisplayString((_d = unref(user)) == null ? void 0 : _d.email), 1)
                                    ])
                                  ]),
                                  createVNode("div", { class: "mt-2 bg-blue-50 rounded-lg px-3 py-1.5 text-sm text-blue-700 flex items-center" }, [
                                    createVNode(_component_q_icon, {
                                      name: "verified",
                                      size: "xs",
                                      color: "blue-7",
                                    ...
                                    createVNode("span", null, "Verified Account")
                                  ])
                                ]),
                        ...
                        return [
                          createVNode(_component_q_avatar, {
                            ...
                            default: withCtx(() => {
                              ...
                              return [
                                createVNode("img", {
                                  src: ((_a = unref(user)) == null ? void 0 : _a.photoURL) || "https://ui-avatars.com/api/?name=" + (((_b = unref(user)) == null ? void 0 : _b.displayName) || "User")
                                }, null, 8, ["src"])
                              ];
                            }),
                            _: 1
                              ...
                              return [
                                createVNode("div", { class: "px-4 py-3 border-b border-gray-100" }, [
                                  createVNode("div", { class: "flex items-center space-x-3" }, [
                                    ...
                                    createVNode("div", { class: "flex flex-col" }, [
                                      createVNode("span", { class: "font-medium text-gray-800" }, toDisplayString(((_a = unref(user)) == null ? void 0 : _a.displayName) || "User"), 1),
                                      createVNode("span", { class: "text-sm text-blue-600 truncate max-w-[180px]" }, toDisplayString((_b = unref(user)) == null ? void 0 : _b.email), 1)
                                    ])
                                  ]),
                                  createVNode("div", { class: "mt-2 bg-blue-50 rounded-lg px-3 py-1.5 text-sm text-blue-700 flex items-center" }, [
                                    createVNode(_component_q_icon, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_q_layout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_q_page_container, { class: "p-0" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            return [
              createVNode(_component_q_page_container, { class: "p-0" }, {
                default: withCtx(() => [
                  createVNode(_component_q_page, null, {
                    default: withCtx(() => [
                      createVNode(_sfc_main$2),
...
//# sourceMappingURL=default-BtvNXp5E.mjs.map
