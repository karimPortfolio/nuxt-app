    ...
    <div class="hidden lg:block lg:w-1/2 relative overflow-hidden">
      <div class="carousel-container h-full">
        ...
        >
          ...
          />
          <div
            class="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent flex flex-col justify-end p-12"
          >
        ...
        <!-- Carousel indicators -->
        <div
          class="absolute bottom-6 left-0 right-0 flex justify-center gap-2 z-50"
        >
          <button
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8">
      <div class="max-w-md w-full">
        <div class="text-center mb-8">
          <h2 class="text-3xl font-bold text-indigo-600 text-start mb-1">
            Welcome back
          </h2>
          <p class="text-gray-600 text-start">Sign in to your account</p>
        </div>

        <div v-if="validationErrors" class="text-red-500 text-sm mb-4">
          <div class="bg-red-50 border-l-4 border-red-500 rounded-md p-4 mb-4">
            <div class="ml-3">
        ...
        <form class="space-y-6">
          ...
          <button
            ...
            @click="handleLogin"
            :loading="loading"
            class="w-full bg-indigo-600 text-white py-3 px-4 rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200"
          >
            Sign In
          </button>
